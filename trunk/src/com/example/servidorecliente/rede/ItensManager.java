...
public class ItensManager {
	...
	public void CreateItens(int larguraItem, int alturaItem, Boolean player1) {
		...
		if (player1) {
			Impulso.set(larguraItem, 6 * alturaItem,
					(int) (2.1f * larguraItem), (int) (7.5f * alturaItem));
			...
			Impulso.set((int) (5.5 * larguraItem), 6 * alturaItem,
					(int) (6.5f * larguraItem), (int) (7.5 * alturaItem));
